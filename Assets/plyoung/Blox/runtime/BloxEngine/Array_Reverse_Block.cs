...
{
	[BloxBlock("Common/Array/Reverse", BloxBlockType.Action, Order = 200, ContextType = typeof(Array), ReturnType = typeof(Array))]
	public class Array_Reverse_Block : BloxBlock
	{
